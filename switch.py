...
class loginpage(object):
    ...
    def switchtomainapp(self):
        self.window = QtWidgets.QWidget()
        self.ui = mainapplication()
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "login user"))
...
class mainapplication(object):
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(60, 70, 291, 101))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "window2"))
        self.label.setText(' welcome {} :)'.format(username))
